...
function createRound() {
    ...
    $.ajax({
        type: "post",
        url: "http://xug98.cn/round?courseId="+Cookies.get("course"),
        dataType: "json",
        contentType: "application/json",
        success: function(data, textStatus, xhr) {
            console.log(data);
...
function createRoundForScore() {
    ...
    $.ajax({
        type: "put",
        // url: "http://xug98.cn/round/" + Cookies.get("round"),
        url: "http://xug98.cn/round/26",
...
function createRoundForClass() {
    ...
    $.ajax({
        type: "post",
        url: "http://xug98.cn/round/klassround",
        dataType: "json",
        data: JSON.stringify(ata),
        contentType: "application/json",
        success: function() {
...
function getPptByAttendance(attendanceId) {
    $.ajax({
        type: "get",
        url:
            "http://xug98.cn/attendance/" + attendanceId + "/ppt",
        dataType: "json",
        contentType: "application/json;",
        success: function(data, textStatus, xhr) {
            if (xhr.status === 200) {
...
function getTeamTotalScoreByRound(roundId) {
    $.ajax({
        ...
        url:
            "http://xug98.cn/course/" + Cookies.get("course") + "/round/"+ roundId + "/score",
        dataType: "json",
        contentType: "application/json;",
        success: function(data, textStatus, xhr) {
            if (xhr.status === 200) {
...
function getTeamDetailScoreByRound(roundId,teamId) {
    ...
    $.ajax({
        type: "get",
        url:
            "http://xug98.cn/round/" + roundId + "/score?teamId="+ teamId,
        dataType: "json",
        async : false,
        contentType: "application/json;",
        success: function(data, textStatus, xhr) {
...
function deleteTeamShare(shareId) {
    ...
    if (result) {
        $.ajax({
            type: "delete",
            url: "http://xug98.cn/course/teamshare/" + shareId,
            dataType: "json",
            contentType: "application/json;",
            error: function(data, textStatus, xhr) {
                console.log(cid);
...
function deleteSeminarShare(shareId) {
    ...
    if (result) {
        $.ajax({
            type: "delete",
            url: "http://xug98.cn/course/seminarshare/" + shareId,
            dataType: "json",
            contentType: "application/json;",
            error: function(data, textStatus, xhr) {
                console.log(cid);
